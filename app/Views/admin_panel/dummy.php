...
<script src="apps/inbox/inbox.js" async=""></script><script src="../libs/js/moment/moment.js" async=""></script><script src="apps/contact/contact.js" async=""></script><style type="text/css">.jqstooltip { position: absolute;left: 0px;top: 0px;visibility: hidden;background: rgb(0, 0, 0) transparent;background-color: rgba(0,0,0,0.6);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000);-ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000)";color: white;font: 10px arial, san serif;text-align: left;white-space: nowrap;padding: 5px;border: 1px solid white;z-index: 10000;}.jqsfield { color: white;font: 10px arial, san serif;text-align: left;}</style></head>
<body ng-app="app" ng-controller="AppCtrl" class="pace-done" ng-class="{'container': app.setting.boxed, 'ie': isIE,'smart': isSmart}"><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="transform: translate3d(100%, 0px, 0px);">
...
<div class="p-a-md box-color r box-shadow-z1 text-color m-a">
  <div class="m-b text-sm float-centre">
   <h6>Sign in with your NewsPortal Account</h6>
 </div>
  <form  method="POST" action="<?= base_url('auth/login_Check') ?>" >
                        <?=csrf_field()?>
    ...
    <div class="md-form-group float-label">
      <input type="email" class="md-input ng-pristine ng-untouched ng-empty ng-valid-email ng-invalid ng-invalid-required" ng-model="user.email" required=""><label>Email</label>
    </div>
    <div class="md-form-group float-label">
    ...
    <div class="p-v-lg text-center">
     <div>Do not have an account? 
      <a class="text-primary _600">Sign up</a>
    </div>
  </div>
</div>
</div>
...
<script src="../libs/jquery/flot/jquery.flot.js"></script><script src="../libs/jquery/flot/jquery.flot.resize.js"></script><script src="../libs/jquery/flot/jquery.flot.pie.js"></script><script src="../libs/jquery/flot.tooltip/js/jquery.flot.tooltip.min.js"></script><script src="../libs/jquery/flot-spline/js/jquery.flot.spline.min.js"></script><script src="../libs/jquery/flot.orderbars/js/jquery.flot.orderBars.js"></script><script src="../libs/jquery/jquery.sparkline/dist/jquery.sparkline.retina.js"></script><div class="flotTip" style="display: none; position: absolute;"></div></body></html>