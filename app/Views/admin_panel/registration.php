...
<script src="apps/inbox/inbox.js" async=""></script>
<script src="../libs/js/moment/moment.js" async=""></script>
...
<div class="p-a-md box-color r box-shadow-z1 text-color m-a">
  <div class="m-b text-sm float-centre">
   <h5 class="">News Registration Form </h5>
 </div>
                        <form method="POST" action="<?=base_url('auth/save')?>" id="register-form"  enctype="multipart/form-data">
                            <?=csrf_field()?>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="register" id="register" class="btn primary btn-block p-x-md" value="Register"/>
                             </div>
                        </form>
                    </div>
                    <div class="p-v-lg text-center">
                         <div>If you have an account?
                          <a ui-sref="access.signup" href="<?= base_url('/') ?>" class="text-primary _600">Sign in</a>
                        </div>
                    </div>
